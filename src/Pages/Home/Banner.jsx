    ...
    >
      ...
      <SwiperSlide className="relative">
        ...
        <div className="absolute top-36 lg:top-1/3 left-10 lg:left-12 w-3/4 lg:w-1/3 space-y-6">
          ...
          <button className="px-5 py-3 bg-transparent border text-gray-900 hover:text-white border-black hover:border-0 hover:bg-[#FDD8D6] cursor-pointer text-base lg:text-xl font-medium uppercase transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
            Enroll Now
          </button>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide className="relative">
        ...
        <div className="absolute top-36 lg:top-1/3 right-10 lg:right-12 text-right w-3/4 lg:w-1/3 space-y-6">
          ...
          <p className="text-base lg:text-xl font-medium text-[#DDDCDC]">
          ...
          <button className="px-5 py-3 bg-transparent border text-[#FDD8D6] hover:text-white hover:bg-[#FDD8D6] cursor-pointer text-base lg:text-xl font-medium uppercase transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
            Enroll Now
          </button>
        </div>
      </SwiperSlide>
